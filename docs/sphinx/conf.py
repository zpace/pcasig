...
from pcasig import __version__
...
project = 'pcasig'
copyright = '{0}, {1}'.format('2019', 'Zachary Pace')
author = 'Zachary Pace'
...
htmlhelp_basename = '{0}pdoc'.format('pcasig')
...
man_pages = [
    (master_doc, 'pcasig', u'{0} Documentation'.format(project),
     [author], 1)
]
